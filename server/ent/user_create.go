...
func (_c *UserCreate) SetVeasion(v int) *UserCreate {
	_c.mutation.SetVeasion(v)
	return _c
}
...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.Veasion(); !ok {
		return &ValidationError{Name: "veasion", err: errors.New(`ent: missing required field "User.veasion"`)}
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Veasion(); ok {
