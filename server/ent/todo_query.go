...
func (_q *TodoQuery) QueryAuthor() *UserQuery {
...
func (_q *TodoQuery) WithAuthor(opts ...func(*UserQuery)) *TodoQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *TodoQuery) loadAuthor(ctx context.Context, query *UserQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *User)) error {
...
func (_q *TodoQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAuthor != nil {
			_spec.Node.AddColumnOnce(todo.FieldAuthorID)
		}
	}
