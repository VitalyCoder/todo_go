...
func (_c *TodoCreate) SetVersion(v int) *TodoCreate {
...
func (_c *TodoCreate) SetAuthorID(v uuid.UUID) *TodoCreate {
...
func (_c *TodoCreate) SetAuthor(v *User) *TodoCreate {
...
func (_c *TodoCreate) check() error {
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`ent: missing required field "Todo.version"`)}
	}
	...
	if _, ok := _c.mutation.AuthorID(); !ok {
		return &ValidationError{Name: "author_id", err: errors.New(`ent: missing required field "Todo.author_id"`)}
	}
