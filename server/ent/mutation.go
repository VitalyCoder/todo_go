...
func (m *TodoMutation) SetAuthorID(u uuid.UUID) {
	m.author = &u
}

// AuthorID returns the value of the "author_id" field in the mutation.
func (m *TodoMutation) AuthorID() (r uuid.UUID, exists bool) {
	v := m.author
	if v == nil {
		return
	}
...
// OldAuthorID returns the old "author_id" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldAuthorID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) ResetAuthorID() {
	m.author = nil
}
...
func (m *TodoMutation) ClearAuthor() {
	...
	m.clearedFields[todo.FieldAuthorID] = struct{}{}
}
...
func (m *TodoMutation) Fields() []string {
	...
	if m.author != nil {
		fields = append(fields, todo.FieldAuthorID)
	}
	return fields
}
...
// SetVeasion sets the "veasion" field.
func (m *UserMutation) SetVeasion(i int) {
	m.veasion = &i
	m.addveasion = nil
}

// Veasion returns the value of the "veasion" field in the mutation.
func (m *UserMutation) Veasion() (r int, exists bool) {
	v := m.veasion
	if v == nil {
		return
	}
...
// OldVeasion returns the old "veasion" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldVeasion(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldVeasion is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldVeasion requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldVeasion: %w", err)
	}
	return oldValue.Veasion, nil
}

// AddVeasion adds i to the "veasion" field.
func (m *UserMutation) AddVeasion(i int) {
	if m.addveasion != nil {
		*m.addveasion += i
	} else {
		m.addveasion = &i
...
// AddedVeasion returns the value that was added to the "veasion" field in this mutation.
func (m *UserMutation) AddedVeasion() (r int, exists bool) {
	v := m.addveasion
	if v == nil {
		return
	}
...
// ResetVeasion resets all changes to the "veasion" field.
func (m *UserMutation) ResetVeasion() {
	m.veasion = nil
	m.addveasion = nil
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.veasion != nil {
		fields = append(fields, user.FieldVeasion)
	}
	if m.full_name != nil {
