...
func (_u *UserUpdate) SetVeasion(v int) *UserUpdate {
	_u.mutation.ResetVeasion()
	_u.mutation.SetVeasion(v)
	return _u
}

// SetNillableVeasion sets the "veasion" field if the given value is not nil.
func (_u *UserUpdate) SetNillableVeasion(v *int) *UserUpdate {
	if v != nil {
		_u.SetVeasion(*v)
	}
	return _u
...
// AddVeasion adds value to the "veasion" field.
func (_u *UserUpdate) AddVeasion(v int) *UserUpdate {
	_u.mutation.AddVeasion(v)
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Veasion(); ok {
		_spec.SetField(user.FieldVeasion, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedVeasion(); ok {
		_spec.AddField(user.FieldVeasion, field.TypeInt, value)
	}
...
// SetVeasion sets the "veasion" field.
func (_u *UserUpdateOne) SetVeasion(v int) *UserUpdateOne {
	_u.mutation.ResetVeasion()
	_u.mutation.SetVeasion(v)
	return _u
}
...
// SetNillableVeasion sets the "veasion" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableVeasion(v *int) *UserUpdateOne {
	if v != nil {
		_u.SetVeasion(*v)
	}
	return _u
...
// AddVeasion adds value to the "veasion" field.
func (_u *UserUpdateOne) AddVeasion(v int) *UserUpdateOne {
	_u.mutation.AddVeasion(v)
	return _u
}
